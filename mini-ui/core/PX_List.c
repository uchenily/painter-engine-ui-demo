...
px_list_node *PX_ListNodeNext(px_list_node *node) { return node->pnext; }
...
px_int PX_ListSize(px_list *list) { return list->size; }
...
px_void PX_ListFree(px_list *list) { PX_ListClear(list); }
