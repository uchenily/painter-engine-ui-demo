...
px_void
PX_StringInitAlloc(px_memorypool *mp, px_string *str, px_int allocSize) {
    px_int size = 16;
...
px_bool PX_StringFormat8(px_string *str,
                         const px_char fmt[],
                         px_stringformat _1,
                         px_stringformat _2,
                         px_stringformat _3,
    ...
    finalLen = PX_sprintf8(
        str->buffer, str->bufferlen, fmt, _1, _2, _3, _4, _5, _6, _7, _8);
...
px_bool PX_StringFormat7(px_string *str,
                         const px_char fmt[],
                         px_stringformat _1,
                         px_stringformat _2,
                         px_stringformat _3,
    ...
    return PX_StringFormat8(
        str, fmt, _1, _2, _3, _4, _5, _6, _7, PX_STRINGFORMAT_INT(0));
}

px_bool PX_StringFormat6(px_string *str,
                         const px_char fmt[],
                         px_stringformat _1,
                         px_stringformat _2,
                         px_stringformat _3,
...
px_bool PX_StringFormat5(px_string *str,
                         const px_char fmt[],
                         px_stringformat _1,
                         px_stringformat _2,
                         px_stringformat _3,
...
px_bool PX_StringFormat4(px_string *str,
                         const px_char fmt[],
                         px_stringformat _1,
                         px_stringformat _2,
                         px_stringformat _3,
...
px_bool PX_StringFormat3(px_string *str,
                         const px_char fmt[],
                         px_stringformat _1,
                         px_stringformat _2,
                         px_stringformat _3) {
...
px_bool PX_StringFormat2(px_string *str,
                         const px_char fmt[],
                         px_stringformat _1,
                         px_stringformat _2) {
    return PX_StringFormat8(str,
...
px_bool
PX_StringFormat1(px_string *str, const px_char fmt[], px_stringformat _1) {
    return PX_StringFormat8(str,
                            fmt,
                            _1,
                            PX_STRINGFORMAT_INT(0),
...
px_bool PX_StringIsFloat(px_string *str) { return PX_strIsFloat(str->buffer); }
...
px_int PX_StringLen(px_string *str) { return PX_strlen(str->buffer); }
...
px_bool PX_StringRemoveChar(px_string *str, px_int index) {
    if (index >= 0 && index < PX_strlen(str->buffer)) {
        PX_memcpy(str->buffer + index,
                  str->buffer + index + 1,
                  PX_strlen(str->buffer + index));
        str->exreg_strlen--;
        return PX_TRUE;
    }
    return PX_FALSE;
...
px_bool PX_StringInsert(px_string *str,
                        px_int insertIndex,
                        const px_char *InstrString) {
    ...
    PX_memcpy(
        str->buffer + insertIndex + length, str->buffer + insertIndex, resLen);
    PX_memcpy(str->buffer + insertIndex, InstrString, length);
    PX_StringUpdateExReg(str);
    return PX_TRUE;
}

px_void PX_StringReplaceRange(px_string *str,
                              px_int startindex,
                              px_int endindex,
                              px_char *replaceto) {
    px_string tempStr;
...
px_bool PX_StringTrimer_Solve(px_string *pstring,
                              px_char *parseCode,
                              px_char *ReplaceCode) {
    ...
    while (pstring->buffer[oft]) {
        ...
        while (PX_TRUE) {
            ...
            if (parseCode[repj] == '%') {
                ...
                if (mark[regindex]) {
                    // reg 0 as wildcard
                    if (PX_strequ(reg[regindex].buffer, matchedString.buffer)
                        || !regindex) {
                        matchd = PX_TRUE;
                    } else {
                        matchd = PX_FALSE;
