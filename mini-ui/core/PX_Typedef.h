...
#define BigLittleSwap16(A)                                                     \
    ((((px_word) (A) &0xff00) >> 8) | (((px_word) (A) &0x00ff) << 8))
#define BigLittleSwap32(A)                                                     \
    ((((px_dword) (A) &0xff000000) >> 24)                                      \
     | (((px_dword) (A) &0x00ff0000) >> 8)                                     \
     | (((px_dword) (A) &0x0000ff00) << 8)                                     \
     | (((px_dword) (A) &0x000000ff) << 24))
...
px_int PX_sprintf8(px_char *str,
                   px_int str_size,
                   const px_char fmt[],
                   px_stringformat _1,
                   px_stringformat _2,
...
px_void
PX_FFT_2_Shift(_IN px_complex _in[], _OUT px_complex _out[], px_int N_N);
