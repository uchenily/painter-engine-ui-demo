...
static px_int partition_l(PX_QuickSortAtom array[],
                          px_int left,
                          px_int right,
                          px_int pivot_index) {
...
static px_int partition_m(PX_QuickSortAtom array[],
                          px_int left,
                          px_int right,
                          px_int pivot_index) {
    px_float pivot_value = array[pivot_index].weight;
...
void PX_Quicksort_MinToMax(PX_QuickSortAtom array[],
                           px_int left,
                           px_int right) {
...
void PX_Quicksort_MaxToMin(PX_QuickSortAtom array[],
                           px_int left,
                           px_int right) {
    px_int pivot_index = left;
    px_int pivot_new_index;
