...
struct _PX_Linker;
typedef px_bool (*PX_LinkerOpen_func)(struct _PX_Linker *linker,
                                      px_void *userPtr);
typedef px_int (*PX_LinkerRead_func)(struct _PX_Linker *linker,
                                     px_void *data,
                                     px_int datasize,
                                     px_void *userPtr);
typedef px_int (*PX_LinkerWrite_func)(struct _PX_Linker *linker,
                                      px_void *data,
                                      px_int datasize,
                                      px_void *userPtr);
typedef px_void (*PX_LinkerClose_func)(struct _PX_Linker *linker,
                                       px_void *userptr);
...
px_void PX_LinkerInitialize(PX_Linker *linker,
                            PX_LinkerOpen_func open,
                            PX_LinkerRead_func read,
                            PX_LinkerWrite_func write,
                            PX_LinkerClose_func close,
