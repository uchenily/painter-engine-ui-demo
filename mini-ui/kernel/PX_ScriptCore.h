...
// strset
// [reg,local,global],[reg,local,global,int],[reg,local,global,string,int]
...
// memfind
// [reg,local,global],[reg,local,global,memory],[reg,local,global,memory] memlen
// [reg,local,global],[reg,local,global,memory] memcat
// [reg,local,global],[reg,local,global,memory] memtstr [reg,local,global]
...
#define PX_VM_VARIABLE_TYPE_NUMERIC                                            \
    (PX_VM_VARIABLE_TYPE_INT | PX_VM_VARIABLE_TYPE_FLOAT)
