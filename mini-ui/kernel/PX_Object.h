...
#define PX_OBJECT_INHERIT_CODE(__pObject, objx, objy, objWidth, objHeight)     \
    do {                                                                       \
        px_float ix, iy;                                                       \
        PX_ObjectGetInheritXY(__pObject, &ix, &iy);                            \
        objx = (__pObject->x + ix);                                            \
        objy = (__pObject->y + iy);                                            \
        objWidth = __pObject->Width;                                           \
        objHeight = __pObject->Height;                                         \
    } while (0);
...
typedef px_void (*Function_ObjectBeginRender)(px_surface *,
                                              PX_Object *,
                                              px_dword);
typedef px_void (*Function_ObjectRender)(px_surface *psurface,
                                         PX_Object *,
                                         px_uint elapsed);
typedef px_void (*Function_ObjectEndRender)(px_surface *,
                                            PX_Object *,
                                            px_dword);
typedef px_void (*Function_ObjectFree)(PX_Object *);
typedef px_void (*Function_ObjectLinkChild)(PX_Object *parent,
                                            PX_Object *child);
...
struct _PX_Object_EventAction {
    px_uint EventAction;
    px_void (*EventActionFunc)(PX_Object *,
                               PX_Object_Event e,
                               px_void *user_ptr);
    px_void *user_ptr;
...
px_void
PX_ObjectRender(px_surface *pSurface, PX_Object *Object, px_uint elapsed);
...
typedef PX_Object *(*px_designer_createfunc)(px_memorypool *mp,
                                             PX_Object *pparent,
                                             px_float x,
                                             px_float y,
                                             px_float width,
...
typedef px_void (*px_designer_setproperty_float)(PX_Object *pObject,
                                                 px_float v);
typedef px_void (*px_designer_setproperty_int)(PX_Object *pObject, px_int v);
typedef px_void (*px_designer_setproperty_string)(PX_Object *pObject,
                                                  const px_char v[]);
