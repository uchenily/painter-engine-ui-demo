...
typedef struct {
    ...
    PX_OBJECT_OSCILLOSCOPE_TEXT_DISPLAYMODE leftTextDisplayMode,
        RightTextDisplayMode;
...
//
px_void PX_Object_OscilloscopeSetMinVerticalPixelDividing(PX_Object *pObject,
                                                          px_int val);
px_void PX_Object_OscilloscopeSetMinHorizontalPixelDividing(PX_Object *pObject,
                                                            px_int val);
px_void PX_Object_OscilloscopeSetHorizontalDividing(PX_Object *pObject,
                                                    px_int Count);
px_void PX_Object_OscilloscopeSetLeftVerticalDividing(PX_Object *pObject,
                                                      px_int Count);
px_void PX_Object_OscilloscopeSetRightVerticalDividing(PX_Object *pObject,
                                                       px_int Count);
px_void PX_Object_OscilloscopeSetLineMode(PX_Object *pObject,
...
px_void PX_Object_OscilloscopeSetDataLineWidth(PX_Object *pObject,
                                               px_float linewidth);
px_void PX_Object_OscilloscopeSetDataShow(PX_Object *pObject,
                                          px_int index,
                                          px_bool show);
...
// px_void PX_Object_OscilloscopeSetTitleLeft(PX_Object *pObject,const px_char *
// title); px_void PX_Object_OscilloscopeSetTitleRight(PX_Object *pObject,const
// px_char * title);
px_void PX_Object_OscilloscopeSetTitleTop(PX_Object *pObject,
                                          const px_char *title);
px_void PX_Object_OscilloscopeSetTitleBottom(PX_Object *pObject,
                                             const px_char *title);

px_void PX_Object_OscilloscopeSetMarkValueEnabled(PX_Object *pObject,
                                                  px_bool Enabled);
...
px_void PX_Object_OscilloscopeAddData(PX_Object *pObject,
                                      PX_Object_OscilloscopeData data);
px_void PX_Object_OscilloscopeClearData(PX_Object *pObject);
px_void PX_Object_OscilloscopeAddOscilloscopeFlagLine(
...
px_void PX_Object_FilterEditorSetOperateCount(PX_Object *Object,
                                              px_int opcount);
...
px_void PX_Object_FilterEditorSetVerticalDividing(PX_Object *Object,
                                                  px_int div);
px_void
PX_Object_FilterEditorMapData(PX_Object *Object, px_double data[], px_int size);
