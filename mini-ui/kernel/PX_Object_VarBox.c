...
px_void
PX_Object_VarBoxOnConfirm(PX_Object *pObject, PX_Object_Event e, px_void *ptr) {
    PX_Object_VarBox *pdesc
        = PX_ObjectGetDesc(PX_Object_VarBox, ((PX_Object *) ptr));
...
px_void
PX_Object_VarBoxOnKeyDown(PX_Object *pObject, PX_Object_Event e, px_void *ptr) {
    if (e.Event == PX_OBJECT_EVENT_KEYDOWN
        && PX_Object_Event_GetKeyDown(e) == '\r') {
        PX_Object_VarBoxOnConfirm(
            pObject, PX_OBJECT_BUILD_EVENT(PX_OBJECT_EVENT_EXECUTE), ptr);
    }
}

px_void
PX_Object_VarBoxOnCancel(PX_Object *pObject, PX_Object_Event e, px_void *ptr) {
    PX_Object_VarBoxClose((PX_Object *) ptr);
}

px_void PX_Object_VarBoxOnTypeChanged(PX_Object *pObject,
                                      PX_Object_Event e,
                                      px_void *ptr) {
...
PX_Object *PX_Object_VarBoxCreate(px_memorypool *mp,
                                  PX_Object *Parent,
                                  px_int x,
                                  px_int y,
                                  px_int width,
    ...
    pdesc->various_size = PX_Object_VariousCreate(mp,
                                                  pdesc->widget,
                                                  width / 2 - 128,
                                                  112,
                                                  256,
                                                  ...
                                                  PX_OBJECT_VARIOUS_TYPE_EDIT,
                                                  fontmodule);
    PX_Object_VariousSetEditStyle(pdesc->various_size,
    ...
    PX_Object_SelectBarAddItem(pdesc->selectbar_type,
                               "Type: float32(LE IEEE754)"); // 8
    PX_Object_SelectBarAddItem(pdesc->selectbar_type,
                               "Type: double64(LE IEEE754)");          // 9
