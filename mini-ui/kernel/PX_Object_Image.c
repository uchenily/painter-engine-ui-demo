...
px_void PX_Object_ImageRender(px_surface *psurface,
                              PX_Object *pObject,
                              px_uint elapsed) {
...
PX_Object *PX_Object_ImageCreate(px_memorypool *mp,
                                 PX_Object *Parent,
                                 px_int x,
                                 px_int y,
                                 px_int width,
    ...
    PX_Object_Image *pImage
        = (PX_Object_Image *) MP_Malloc(mp, sizeof(PX_Object_Image));
    if (pImage == PX_NULL) {
        return PX_NULL;
    }
