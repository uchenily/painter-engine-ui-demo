...
px_point2D PX_Object_JoystickGetVector(PX_Object *pObject) {
    ...
    if (pObject->Type != PX_OBJECT_TYPE_JOYSTICK) {
        ...
        p.x = ((PX_Object_Joystick *) (pObject->pObject))->Distance
              * (px_float) PX_cosd(
                  ((PX_Object_Joystick *) (pObject->pObject))->Angle);
...
px_void
Func_JoystickRender(px_surface *pSurface, PX_Object *pObject, px_uint elapsed);
px_void
Func_JoystickOnCursorDown(PX_Object *pObject, PX_Object_Event e, px_void *ptr);
px_void
Func_JoystickOnCursorDrag(PX_Object *pObject, PX_Object_Event e, px_void *ptr);
px_void
Func_JoystickOnCursorUp(PX_Object *pObject, PX_Object_Event e, px_void *ptr);

PX_Object *PX_Object_JoystickCreate(px_memorypool *mp,
                                    PX_Object *Parent,
                                    px_float x,
                                    px_float y,
                                    px_float deferentR,
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           Func_JoystickOnCursorDown,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORDRAG,
                           Func_JoystickOnCursorDrag,
                           PX_NULL);
    PX_ObjectRegisterEvent(
        pObject, PX_OBJECT_EVENT_CURSORUP, Func_JoystickOnCursorUp, PX_NULL);
...
Func_JoystickOnCursorDown(PX_Object *pObject, PX_Object_Event e, px_void *ptr) {
    ...
    y = PX_Object_Event_GetCursorY(e) - objy, r = PX_sqrt(x * x + y * y);
