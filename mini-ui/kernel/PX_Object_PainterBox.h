...
typedef struct {
    PX_Object *widget;
    PX_Object *color_panel, *button_pen, *button_paint, *button_eraser,
        *button_spray, *button_hand;
    PX_Object *sliderbar_size, *sliderbar_alpha, *sliderbar_smooth,
        *image_present;
...
PX_Object *PX_Object_PainterBoxCreate(px_memorypool *mp,
                                      PX_Object *Parent,
                                      px_int x,
                                      px_int y);
PX_OBJECT_PAINTERBOX_TOOL_TYPE
PX_Object_PainterBoxGetCurrentTool(PX_Object *pObject);
