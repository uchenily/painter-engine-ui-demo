...
PX_ModbusTCP_Write PX_ModbusTCPWriteSingleReg(px_word counter,
                                              px_byte unit,
                                              px_word startAddr,
                                              px_word regdata) {
...
PX_ModbusTCP_Write PX_ModbusTCPWriteSingleBool(px_word counter,
                                               px_byte unit,
                                               px_word startAddr,
                                               px_bool b) {
    PX_ModbusTCP_Write write;
...
PX_ModbusTCP_Read PX_ModbusTCPReadReg(px_word counter,
                                      px_byte unit,
                                      px_word startAddr,
                                      px_int count) {
...
PX_ModbusTCP_Read PX_ModbusTCPReadBool(px_word counter,
                                       px_byte unit,
                                       px_word startAddr,
                                       px_int count) {
    PX_ModbusTCP_Read read;
