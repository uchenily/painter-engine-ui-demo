...
px_bool
PX_JsonBuild_Value(PX_Json_Value *pValue, px_string *_out, px_bool bArrayValue);
...
const px_char *PX_JsonValueGetString(PX_Json_Value *pValue,
...
px_bool
PX_JsonSetString(PX_Json *pjson, const px_char payload[], const px_char text[]);
