...
px_bool PX_Object_ColorPanelUpdatePanelTexture(PX_Object *pObject) {
    ...
    d = (px_int) (pObject->Width > pObject->Height ? pObject->Height
                                                   : pObject->Width);
    ...
    PX_GeoDrawRing(
        &pdesc->panel, d / 2, d / 2, d / 2 - 2.f, 2, PX_COLOR_BLACK, 0, 360);
    PX_GeoDrawRing(
        &pdesc->panel, d / 2, d / 2, d / 2 - 18.f, 2, PX_COLOR_BLACK, 0, 360);
...
px_void PX_Object_ColorPanelRender(px_surface *psurface,
                                   PX_Object *pObject,
                                   px_uint elapsed) {
...
px_void PX_Object_ColorPanelOnCursorCancel(PX_Object *pObject,
                                           PX_Object_Event e,
                                           px_void *ptr) {
    PX_Object_ColorPanel *pdesc;
    pdesc = PX_ObjectGetDesc(PX_Object_ColorPanel, pObject);
...
px_void PX_Object_ColorPanelOnCursorDown(PX_Object *pObject,
                                         PX_Object_Event e,
                                         px_void *ptr) {
    PX_Object_ColorPanel *pdesc;
    px_float x, y, w, h;
    ...
    if (PX_ObjectIsCursorInRegion(pObject, e)) {
        px_float d;
        px_float cx = PX_Object_Event_GetCursorX(e),
                 cy = PX_Object_Event_GetCursorY(e);
        px_float edis;
...
px_void PX_Object_ColorPanelOnCursorDrag(PX_Object *pObject,
                                         PX_Object_Event e,
                                         px_void *ptr) {
    PX_Object_ColorPanel *pdesc;
    px_float x, y, w, h;
...
px_void PX_Object_ColorPanelFree(PX_Object *pObject) {
    PX_Object_ColorPanel *pdesc
        = PX_ObjectGetDesc(PX_Object_ColorPanel, pObject);
    PX_TextureFree(&pdesc->panel);
}

PX_Object *PX_Object_ColorPanelCreate(px_memorypool *mp,
                                      PX_Object *Parent,
                                      px_int x,
                                      px_int y,
                                      px_int width,
    ...
    pObject = PX_ObjectCreateEx(mp,
                                ...
                                0,
                                PX_Object_ColorPanelRender,
                                PX_Object_ColorPanelFree,
                                &desc,
                                sizeof(desc));
    pdesc = PX_ObjectGetDesc(PX_Object_ColorPanel, pObject);
    pdesc->mp = mp;
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           PX_Object_ColorPanelOnCursorDown,
                           pObject);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORDRAG,
                           PX_Object_ColorPanelOnCursorDrag,
                           pObject);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORMOVE,
                           PX_Object_ColorPanelOnCursorCancel,
                           pObject);
    PX_ObjectRegisterEvent(pObject,
