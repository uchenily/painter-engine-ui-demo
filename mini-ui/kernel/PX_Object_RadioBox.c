...
px_void PX_Object_RadioBoxOnMouseMove(PX_Object *Object,
                                      PX_Object_Event e,
                                      px_void *user_ptr) {
...
px_void PX_Object_RadioBoxOnMouseLButtonDown(PX_Object *Object,
                                             PX_Object_Event e,
                                             px_void *user_ptr) {
    PX_Object_RadioBox *pcb = PX_Object_GetRadioBox(Object);
    px_float x = (PX_Object_Event_GetCursorX(e));
...
px_void PX_Object_RadioBoxOnMouseLButtonUp(PX_Object *Object,
                                           PX_Object_Event e,
                                           px_void *user_ptr) {
    PX_Object_RadioBox *pcb = PX_Object_GetRadioBox(Object);
...
px_void PX_Object_RadioBoxRender(px_surface *psurface,
                                 PX_Object *pObject,
                                 px_uint elapsed) {
...
PX_Object *PX_Object_RadioBoxCreate(px_memorypool *mp,
                                    PX_Object *Parent,
                                    px_int x,
                                    px_int y,
                                    px_int Width,
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           PX_Object_RadioBoxOnMouseMove,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORDOWN,
                           PX_Object_RadioBoxOnMouseLButtonDown,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORUP,
                           PX_Object_RadioBoxOnMouseLButtonUp,
                           PX_NULL);
    return pObject;
}
...
// radiobox
//////////////////////////////////////////////////////////////////////////
PX_Object *PX_Designer_RadioBoxCreate(px_memorypool *mp,
                                      PX_Object *pparent,
                                      px_float x,
                                      px_float y,
                                      px_float width,
    ...
    return PX_Object_RadioBoxCreate(
        mp, pparent, (px_int) x, (px_int) y, 108, 28, "RadioButton", fm);
}
