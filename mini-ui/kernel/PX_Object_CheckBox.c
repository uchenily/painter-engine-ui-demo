...
px_void PX_Object_CheckBoxOnMouseMove(PX_Object *Object,
                                      PX_Object_Event e,
                                      px_void *user_ptr) {
...
px_void PX_Object_CheckBoxOnMouseLButtonDown(PX_Object *Object,
                                             PX_Object_Event e,
                                             px_void *user_ptr) {
    PX_Object_CheckBox *pcb = PX_Object_GetCheckBox(Object);
    px_float x = (PX_Object_Event_GetCursorX(e));
...
px_void PX_Object_CheckBoxOnMouseLButtonUp(PX_Object *Object,
                                           PX_Object_Event e,
                                           px_void *user_ptr) {
    PX_Object_CheckBox *pcb = PX_Object_GetCheckBox(Object);
...
px_void PX_Object_CheckBoxRender(px_surface *psurface,
                                 PX_Object *pObject,
                                 px_uint elapsed) {
...
PX_Object *PX_Object_CheckBoxCreate(px_memorypool *mp,
                                    PX_Object *Parent,
                                    px_int x,
                                    px_int y,
                                    px_int Width,
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           PX_Object_CheckBoxOnMouseMove,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORDOWN,
                           PX_Object_CheckBoxOnMouseLButtonDown,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORUP,
                           PX_Object_CheckBoxOnMouseLButtonUp,
                           PX_NULL);
    return pObject;
}
...
// checkbox
//////////////////////////////////////////////////////////////////////////
PX_Object *PX_Designer_CheckBoxCreate(px_memorypool *mp,
                                      PX_Object *pparent,
                                      px_float x,
                                      px_float y,
                                      px_float width,
    ...
    return PX_Object_CheckBoxCreate(
        mp, pparent, (px_int) x, (px_int) y, 96, 28, "CheckBox", fm);
}
