...
px_void PX_Object_LabelRender(px_surface *psurface,
                              PX_Object *pObject,
                              px_uint elapsed) {
    px_int x, y, w, h;
    ...
    if (pLabel->bBorder) {
        switch (pLabel->style) {
            ...
            default:
                PX_GeoDrawBorder(
                    psurface, x, y, x + w, y + h - 1, 1, pLabel->borderColor);
        }
    }
...
PX_Object *PX_Object_LabelCreate(px_memorypool *mp,
                                 PX_Object *Parent,
                                 px_int x,
                                 px_int y,
                                 px_int Width,
    ...
    PX_Object_Label *pLable
        = (PX_Object_Label *) MP_Malloc(mp, sizeof(PX_Object_Label));
    if (pLable == PX_NULL) {
        return PX_NULL;
    }
...
px_void PX_Object_LabelSetStyle(PX_Object *pObject,
...
px_int PX_Object_LabelGetTextRenderWidth(PX_Object *pObject) {
    ...
    if (pLabel) {
        ...
        PX_FontModuleTextGetRenderWidthHeight(
            pLabel->fontModule, pLabel->Text, &w, &h);
        return w;
    }
    return 0;
}
...
// Label
//////////////////////////////////////////////////////////////////////////
PX_Object *PX_Designer_LabelCreate(px_memorypool *mp,
                                   PX_Object *pparent,
                                   px_float x,
                                   px_float y,
                                   px_float width,
    ...
    return PX_Object_LabelCreate(mp,
                                 pparent,
                                 (px_int) x,
                                 (px_int) y,
                                 128,
