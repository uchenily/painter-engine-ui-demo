...
PX_UiBaseInfo
PX_UIGetBaseInfo(PX_Json_Value *json_value, px_int width, px_int height) {
...
px_bool PX_UI_GetColor(PX_Json_Value *json_value,
                       const px_char name[],
                       px_color *color) {
    PX_Json_Value *pSubValue = PX_NULL;
...
px_bool
PX_UI_GetBool(PX_Json_Value *json_value, const px_char name[], px_bool *b) {
    PX_Json_Value *pSubValue = PX_NULL;
    pSubValue = PX_JsonGetObjectValue(json_value, name);
    if (pSubValue) {
...
px_bool PX_UI_GetNumber(PX_Json_Value *json_value,
                        const px_char name[],
                        px_double *number) {
    PX_Json_Value *pSubValue = PX_NULL;
    pSubValue = PX_JsonGetObjectValue(json_value, name);
...
px_bool PX_UI_GetString(PX_Json_Value *json_value,
                        const px_char name[],
                        px_char str[],
                        px_int size) {
    PX_Json_Value *pSubValue = PX_NULL;
...
PX_Object *PX_UI_CreateNode(PX_UI *ui,
                            PX_Object *parent,
                            PX_Json_Value *json_value,
                            px_int width,
                            px_int height) {
    return PX_ObjectCreate(ui->ui_mp, parent, 0, 0, 0, 0, 0, 0);
}

PX_Object *PX_UI_CreateLabel(PX_UI *ui,
                             PX_Object *parent,
                             PX_Json_Value *json_value,
                             px_int width,
                             px_int height) {
    ...
    pObject = PX_Object_LabelCreate(ui->ui_mp,
                                    parent,
                                    (px_int) baseInfo.x,
                                    (px_int) baseInfo.y,
                                    (px_int) baseInfo.width,
                                    (px_int) baseInfo.height,
                                    text,
                                    ui->fontmodule,
                                    fontColor);
...
PX_Object *PX_UI_CreateProcessbar(PX_UI *ui,
                                  PX_Object *parent,
                                  PX_Json_Value *json_value,
                                  px_int width,
                                  px_int height) {
    ...
    pObject = PX_Object_ProcessBarCreate(ui->ui_mp,
                                         parent,
                                         (px_int) baseInfo.x,
                                         (px_int) baseInfo.y,
                                         (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateImage(PX_UI *ui,
                             PX_Object *parent,
                             PX_Json_Value *json_value,
                             px_int width,
                             px_int height) {
    ...
    pObject = PX_Object_ImageCreate(ui->ui_mp,
                                    parent,
                                    (px_int) baseInfo.x,
                                    (px_int) baseInfo.y,
                                    (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateSliderbar(PX_UI *ui,
                                 PX_Object *parent,
                                 PX_Json_Value *json_value,
                                 px_int width,
                                 px_int height) {
    ...
    pObject = PX_Object_SliderBarCreate(ui->ui_mp,
                                        parent,
                                        (px_int) baseInfo.x,
                                        (px_int) baseInfo.y,
                                        (px_int) baseInfo.width,
    ...
    if (pObject) {
        ...
        if (pSubValue && pSubValue->type == PX_JSON_VALUE_TYPE_NUMBER) {
            PX_Object_SliderBarSetSliderButtonLength(
                pObject, (px_int) pSubValue->_number);
        }
    }

    return pObject;
}
PX_Object *PX_UI_CreateButton(PX_UI *ui,
                              PX_Object *parent,
                              PX_Json_Value *json_value,
                              px_int width,
                              px_int height) {
    ...
    pObject = PX_Object_PushButtonCreate(ui->ui_mp,
                                         parent,
                                         (px_int) baseInfo.x,
                                         (px_int) baseInfo.y,
                                         (px_int) baseInfo.width,
    ...
    if (PX_UI_GetString(json_value, "style", style, sizeof(style))) {
        if (PX_strequ(style, "round")) {
            PX_Object_PushButtonSetStyle(pObject,
...
PX_Object *PX_UI_CreateEdit(PX_UI *ui,
                            PX_Object *parent,
                            PX_Json_Value *json_value,
                            px_int width,
                            px_int height) {
    ...
    pObject = PX_Object_EditCreate(ui->ui_mp,
                                   parent,
                                   (px_int) baseInfo.x,
                                   (px_int) baseInfo.y,
                                   (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateScrollArea(PX_UI *ui,
                                  PX_Object *parent,
                                  PX_Json_Value *json_value,
                                  px_int width,
                                  px_int height) {
    ...
    pObject = PX_Object_ScrollAreaCreate(ui->ui_mp,
                                         parent,
                                         (px_int) baseInfo.x,
                                         (px_int) baseInfo.y,
                                         (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateAutoText(PX_UI *ui,
                                PX_Object *parent,
                                PX_Json_Value *json_value,
                                px_int width,
                                px_int height) {
    ...
    pObject = PX_Object_AutoTextCreate(ui->ui_mp,
                                       parent,
                                       (px_int) baseInfo.x,
                                       (px_int) baseInfo.y,
                                       (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateCursorButton(PX_UI *ui,
                                    PX_Object *parent,
                                    PX_Json_Value *json_value,
                                    px_int width,
                                    px_int height) {
    ...
    pObject = PX_Object_CursorButtonCreate(ui->ui_mp,
                                           parent,
                                           (px_int) baseInfo.x,
                                           (px_int) baseInfo.y,
                                           (px_int) baseInfo.width,
    ...
    if (PX_UI_GetColor(json_value, "backgroundcolor", &Color)) {
        PX_Object_PushButtonSetBackgroundColor(
            PX_Object_GetCursorButton(pObject)->pushbutton, Color);
    }

    if (PX_UI_GetColor(json_value, "cursorcolor", &Color)) {
        PX_Object_PushButtonSetCursorColor(
            PX_Object_GetCursorButton(pObject)->pushbutton, Color);
    }

    if (PX_UI_GetColor(json_value, "pushcolor", &Color)) {
        PX_Object_PushButtonSetPushColor(
            PX_Object_GetCursorButton(pObject)->pushbutton, Color);
    }

    if (PX_UI_GetColor(json_value, "bordercolor", &Color)) {
        PX_Object_PushButtonSetBorderColor(
            PX_Object_GetCursorButton(pObject)->pushbutton, Color);
    }
    ...
    if (PX_UI_GetString(json_value, "style", style, sizeof(style))) {
        if (PX_strequ(style, "round")) {
            PX_Object_PushButtonSetStyle(
                PX_Object_GetCursorButton(pObject)->pushbutton,
                PX_OBJECT_PUSHBUTTON_STYLE_ROUNDRECT);
        }
    }

    if (PX_UI_GetBool(json_value, "border", &border)) {
        PX_Object_PushButtonSetBorder(
            PX_Object_GetCursorButton(pObject)->pushbutton, border);
    }
    return pObject;
}
PX_Object *PX_UI_CreateVirtualKeyboard(PX_UI *ui,
                                       PX_Object *parent,
                                       PX_Json_Value *json_value,
                                       px_int width,
                                       px_int height) {
    ...
    pObject = PX_Object_VirtualKeyBoardCreate(ui->ui_mp,
                                              parent,
                                              (px_int) baseInfo.x,
                                              (px_int) baseInfo.y,
                                              (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateVirtualNumberKeyboard(PX_UI *ui,
                                             PX_Object *parent,
                                             PX_Json_Value *json_value,
                                             px_int width,
                                             px_int height) {
    ...
    pObject = PX_Object_VirtualNumberKeyBoardCreate(ui->ui_mp,
                                                    parent,
                                                    (px_int) baseInfo.x,
                                                    (px_int) baseInfo.y,
                                                    (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateCheckBox(PX_UI *ui,
                                PX_Object *parent,
                                PX_Json_Value *json_value,
                                px_int width,
                                px_int height) {
    ...
    pObject = PX_Object_CheckBoxCreate(ui->ui_mp,
                                       parent,
                                       (px_int) baseInfo.x,
                                       (px_int) baseInfo.y,
                                       (px_int) baseInfo.width,
    ...
    if (json_value->type == PX_JSON_VALUE_TYPE_OBJECT) {
        if (json_value->name.buffer && json_value->name.buffer[0]) {
            ...
            for (i = 0; i < ui->infos.size; i++) {
                PX_UI_ControllerInfo *pInfo
                    = PX_VECTORAT(PX_UI_ControllerInfo, &ui->infos, i);
...
PX_Object *PX_UI_CreateRadioBox(PX_UI *ui,
                                PX_Object *parent,
                                PX_Json_Value *json_value,
                                px_int width,
                                px_int height) {
    ...
    pObject = PX_Object_RadioBoxCreate(ui->ui_mp,
                                       parent,
                                       (px_int) baseInfo.x,
                                       (px_int) baseInfo.y,
                                       (px_int) baseInfo.width,
...
PX_Object *PX_UI_CreateSelectBar(PX_UI *ui,
                                 PX_Object *parent,
                                 PX_Json_Value *json_value,
                                 px_int width,
                                 px_int height) {
    ...
    pObject = PX_Object_SelectBarCreate(ui->ui_mp,
                                        parent,
                                        (px_int) baseInfo.x,
                                        (px_int) baseInfo.y,
                                        (px_int) baseInfo.width,
    ...
    if (PX_UI_GetString(json_value, "style", style, sizeof(style))) {
        if (PX_strequ(style, "round")) {
            PX_Object_SelectBarSetStyle(pObject,
    ...
    if (pSubValue && pSubValue->type == PX_JSON_VALUE_TYPE_ARRAY) {
        ...
        for (i = 0; i < pSubValue->_array.size; i++) {
            ...
            if (pArrayValue && pArrayValue->type == PX_JSON_VALUE_TYPE_STRING) {
                PX_Object_SelectBarAddItem(pObject,
                                           pArrayValue->_string.buffer);
            }
        }
    }
...
px_bool PX_UIInitialize(px_memorypool *mp,
                        px_memorypool *ui_mp,
                        PX_UI *ui,
    ...
    if (!PX_VectorInitialize(mp, &ui->infos, sizeof(PX_UI_ControllerInfo), 32))
        return PX_FALSE;
    if (!PX_MapInitialize(mp, &ui->ObjectMap)) {
        PX_VectorFree(&ui->infos);
        return PX_FALSE;
    }
    if (!PX_UIAddControllerInfo(ui, "node", PX_UI_CreateNode))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "label", PX_UI_CreateLabel))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "processbar", PX_UI_CreateProcessbar))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "image", PX_UI_CreateImage))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "sliderbar", PX_UI_CreateSliderbar))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "pushbutton", PX_UI_CreateButton))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "edit", PX_UI_CreateEdit))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "scrollarea", PX_UI_CreateScrollArea))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "text", PX_UI_CreateAutoText))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "cursorbutton", PX_UI_CreateCursorButton))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(
            ui, "virtualkeyboard", PX_UI_CreateVirtualKeyboard))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(
            ui, "virtualnumberkeyboard", PX_UI_CreateVirtualNumberKeyboard))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "checkbox", PX_UI_CreateCheckBox))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "radiobox", PX_UI_CreateRadioBox))
        goto _ERROR;
    if (!PX_UIAddControllerInfo(ui, "selectbar", PX_UI_CreateSelectBar))
        goto _ERROR;
    return PX_TRUE;
_ERROR:
...
px_bool PX_UIAddControllerInfo(PX_UI *ui,
...
PX_Object *PX_UICreate(PX_UI *ui,
                       PX_Object *parent,
                       PX_Json_Value *json_value,
                       px_int width,
                       px_int height) {
    ...
    if (json_value->name.buffer && json_value->name.buffer[0]) {
        ...
        for (i = 0; i < ui->infos.size; i++) {
            ...
            if (PX_strequ(pInfo->Type, json_value->name.buffer)) {
                if (pInfo->create_func) {
                    pNewObject = pInfo->create_func(
                        ui, parent, json_value, width, height);
                    if (!pNewObject) {
                        goto _ERROR;
                    }
                    break;
        ...
        pNewObject = PX_ObjectCreate(ui->ui_mp,
                                     parent,
                                     baseInfo.x,
                                     baseInfo.y,
                                     baseInfo.z,
    ...
    pSubValue = PX_JsonGetObjectValue(json_value, "id");
    if (pSubValue && pSubValue->type == PX_JSON_VALUE_TYPE_STRING
        && pSubValue->_string.buffer[0]) {
        if (PX_MapGet(&ui->ObjectMap, pSubValue->_string.buffer)) {
            //"Repeat controller"
            PX_ASSERT();
            goto _ERROR;
        }
        if (PX_MapPut(&ui->ObjectMap, pSubValue->_string.buffer, pNewObject)
...
px_void PX_UIUpdateObjectsPostions(PX_UI *ui,
                                   PX_Object *pObject,
                                   PX_Json_Value *json_value,
                                   px_int width,
                                   px_int height) {
    ...
    if (json_value->type == PX_JSON_VALUE_TYPE_OBJECT) {
        for (i = 0; i < json_value->_object.values.size; i++) {
            ...
            if (PX_UI_IsValidUIObject(ui, pSubValue)) {
                ...
                if (pChildObject) {
                    PX_UIUpdateObjectsPostions(
                        ui, pChildObject, pSubValue, width, height);
                }
                index++;
            }
        }
