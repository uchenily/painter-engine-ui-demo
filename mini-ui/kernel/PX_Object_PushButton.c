...
px_void PX_Object_PushButtonOnMouseMove(PX_Object *Object,
                                        PX_Object_Event e,
                                        px_void *user_ptr) {
...
px_void PX_Object_PushButtonOnMouseLButtonDown(PX_Object *Object,
                                               PX_Object_Event e,
                                               px_void *user_ptr) {
    PX_Object_PushButton *pPushButton = PX_Object_GetPushButton(Object);
    px_float x, y;
...
px_void PX_Object_PushButtonOnMouseLButtonUp(PX_Object *Object,
                                             PX_Object_Event e,
                                             px_void *user_ptr) {
    PX_Object_PushButton *pPushButton = PX_Object_GetPushButton(Object);
    px_float x, y;
...
PX_Object *PX_Object_PushButtonCreate(px_memorypool *mp,
                                      PX_Object *Parent,
                                      px_int x,
                                      px_int y,
                                      px_int Width,
    ...
    PX_Object_PushButton *pPushButton
        = (PX_Object_PushButton *) MP_Malloc(mp, sizeof(PX_Object_PushButton));
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           PX_Object_PushButtonOnMouseMove,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           PX_Object_PushButtonOnMouseLButtonDown,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORUP,
                           PX_Object_PushButtonOnMouseLButtonUp,
                           PX_NULL);

    return pObject;
}

PX_Object *PX_Object_CircleButtonCreate(px_memorypool *mp,
                                        PX_Object *Parent,
                                        px_int x,
                                        px_int y,
                                        px_int Radius,
                                        const px_char *Text,
                                        PX_FontModule *fontmodule) {
    PX_Object *pObject = PX_Object_PushButtonCreate(
        mp, Parent, x, y, Radius * 2, Radius * 2, Text, fontmodule);
    if (pObject) {
        PX_Object_PushButton *pPushButton
            = (PX_Object_PushButton *) pObject->pObject;
...
px_void PX_Object_PushButtonSetBackgroundColor(PX_Object *pObject,
                                               px_color Color) {
...
px_void PX_Object_PushButtonSetTexture(PX_Object *pObject,
                                       px_texture *texture) {
    PX_Object_PushButton *pPushButton = PX_Object_GetPushButton(pObject);
    if (pPushButton) {
...
px_void PX_Object_PushButtonSetStyle(PX_Object *pObject,
...
px_void PX_Object_PushButtonRender(px_surface *psurface,
                                   PX_Object *pObject,
                                   px_uint elapsed) {
    px_int fx, fy;
    PX_Object_PushButton *pPushButton = PX_Object_GetPushButton(pObject);
    ...
    switch (pPushButton->style) {
            ...
            switch (pPushButton->state) {
                ...
                case PX_OBJECT_BUTTON_STATE_ONCURSOR:
                    PX_GeoDrawRect(psurface,
                                   ...
                                   (px_int) objx + (px_int) objWidth - 1,
                                   (px_int) objy + (px_int) objHeight - 1,
                                   pPushButton->CursorColor);
                    break;
            }
            break;
        case PX_OBJECT_PUSHBUTTON_STYLE_ROUNDRECT:
            PX_GeoDrawSolidRoundRect(psurface,
                                     (px_int) objx,
                                     (px_int) objy,
                                     (px_int) objx + (px_int) objWidth - 1,
                                     (px_int) objy + (px_int) objHeight - 1,
                                     pPushButton->roundradius,
                                     pPushButton->BackgroundColor);
            switch (pPushButton->state) {
                case PX_OBJECT_BUTTON_STATE_NORMAL:
                    PX_GeoDrawSolidRoundRect(
                        psurface,
                        (px_int) objx,
                        (px_int) objy,
                        (px_int) objx + (px_int) objWidth - 1,
        ...
        case PX_OBJECT_PUSHBUTTON_STYLE_CIRCLE: {
            PX_GeoDrawSolidCircle(psurface,
                                  (px_int) objx,
                                  (px_int) objy,
                                  (px_int) (pObject->diameter / 2),
                                  pPushButton->BackgroundColor);
            switch (pPushButton->state) {
                case PX_OBJECT_BUTTON_STATE_NORMAL:
                    PX_GeoDrawBall(psurface,
                                   objx,
                                   objy,
                                   (pObject->diameter / 2),
                                   pPushButton->BackgroundColor);
...
// Push button
//////////////////////////////////////////////////////////////////////////
PX_Object *PX_Designer_PushButtonCreate(px_memorypool *mp,
                                        PX_Object *pparent,
                                        px_float x,
                                        px_float y,
                                        px_float width,
    ...
    return PX_Object_PushButtonCreate(
        mp, pparent, (px_int) x, (px_int) y, 128, 64, "PushButton", fm);
}

px_void PX_Designer_PushButtonSetText(PX_Object *pobject,
                                      const px_char text[]) {
