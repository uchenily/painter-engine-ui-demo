...
PX_Object_COMBox_Return PX_Object_COMBoxGetReturn(PX_Object *pObject) {
    ...
    PX_strcpy(info.com,
              PX_Object_VariousGetText(pDesc->various_com),
              sizeof(info.com));
    switch (
        PX_Object_VariousSelectBarGetCurrentIndex(pDesc->various_baudrate)) {
        case 0:
            info.baudRate = 300;
            break;
        case 1:
...
px_void
PX_Object_COMBoxOnConfirm(PX_Object *pObject, PX_Object_Event e, px_void *ptr) {
    PX_Object_COMBox *pdesc
        = PX_ObjectGetDesc(PX_Object_COMBox, ((PX_Object *) ptr));
...
px_void
PX_Object_COMBoxOnCancel(PX_Object *pObject, PX_Object_Event e, px_void *ptr) {
    PX_Object_COMBoxClose((PX_Object *) ptr);
}
...
PX_Object *PX_Object_COMBoxCreate(px_memorypool *mp,
                                  PX_Object *Parent,
                                  px_int x,
                                  px_int y,
                                  px_int width,
    ...
    PX_ObjectRegisterEvent(pdesc->btn_ok,
                           ...
                           PX_Object_COMBoxOnConfirm,
                           pObject);
    PX_ObjectRegisterEvent(pdesc->btn_close,
                           PX_OBJECT_EVENT_EXECUTE,
                           PX_Object_COMBoxOnCancel,
                           pObject);
