...
px_void PX_Object_DesignerBoxRender(px_surface *pSurface,
                                    PX_Object *pObject,
                                    px_dword elapsed) {
    PX_Object_DesignerBox *pDesc
        = PX_ObjectGetDesc(PX_Object_DesignerBox, pObject);
...
px_void PX_Object_DesignerBoxOnCursorDown(PX_Object *pObject,
                                          PX_Object_Event e,
                                          px_void *ptr) {
    px_float x, y;
    px_float objx, objy, objWidth, objHeight;
...
px_void PX_Object_DesignerBoxOnCursorDrag(PX_Object *pObject,
                                          PX_Object_Event e,
                                          px_void *ptr) {
    px_float x, y;
    PX_Object_DesignerBox *pDesc
...
PX_Object *PX_Object_DesignerBoxCreate(px_memorypool *mp,
                                       PX_Object *Parent,
                                       px_float x,
                                       px_float y,
                                       px_float widht,
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           PX_Object_DesignerBoxOnCursorDrag,
                           PX_NULL);
    return pObject;
}
...
px_void PX_Object_DesignerBoxReset(PX_Object *pObject,
                                   px_float x,
                                   px_float y,
                                   px_float width,
                                   px_float height) {
