...
typedef px_int (*PX_ExplorerGetPathFolderCount)(const px_char *path,
                                                const char *filter);
typedef px_int (*PX_ExplorerGetPathFileCount)(const px_char *path,
                                              const char *filter);
typedef px_int (*PX_ExplorerGetPathFolderName)(const char path[],
                                               px_int count,
                                               char FileName[][260],
                                               const char *filter);
typedef px_int (*PX_ExplorerGetPathFileName)(const char path[],
                                             px_int count,
                                             char FileName[][260],
                                             const char *filter);
...
PX_Object *PX_Object_ExplorerCreate(px_memorypool *mp,
                                    PX_Object *Parent,
                                    px_int x,
                                    px_int y,
                                    px_int Width,
...
px_void PX_Object_ExplorerGetPath(PX_Object *Object,
                                  px_char path[PX_EXPLORER_MAX_PATH_LEN],
                                  px_int index);
...
px_void PX_Object_ExplorerSetMaxSelectCount(PX_Object *Object,
                                            px_int selectCount);
