...
px_void PX_Object_ScaleBoxRender(px_surface *psurface,
                                 PX_Object *pObject,
                                 px_uint elapsed) {
    ...
    switch (pScaleBox->editpt_count) {
        ...
        case 1:
            PX_GeoDrawLine(psurface,
                           (px_int) (objx + pScaleBox->edit_pt[0].x),
                           (px_int) (objx + pScaleBox->edit_pt[0].y),
                           (px_int) (objx + pScaleBox->cursor_pt.x),
                           (px_int) (objx + pScaleBox->cursor_pt.y),
                           1,
                           (pScaleBox->linecolor));
        ...
        case 2: {
            ...
            PX_GeoDrawTriangle(
                psurface, pt[0], pt[1], pt[2], pScaleBox->regioncolor);
            PX_GeoDrawTriangle(
                psurface, pt[0], pt[2], pt[3], pScaleBox->regioncolor);
        ...
        case 3: {
            ...
            PX_GeoDrawTriangle(psurface,
                               pScaleBox->scale_pt[0],
                               pScaleBox->scale_pt[1],
                               pScaleBox->scale_pt[2],
                               pScaleBox->regioncolor);
            PX_GeoDrawTriangle(psurface,
                               pScaleBox->scale_pt[0],
                               pScaleBox->scale_pt[2],
                               pScaleBox->scale_pt[3],
                               pScaleBox->regioncolor);

            PX_GeoDrawLine(psurface,
                           (px_int) (objx + pScaleBox->edit_pt[0].x),
                           (px_int) (objx + pScaleBox->edit_pt[0].y),
                           (px_int) (objx + pScaleBox->edit_pt[1].x),
                           (px_int) (objx + pScaleBox->edit_pt[1].y),
                           1,
                           (pScaleBox->linecolor));
            PX_GeoDrawLine(psurface,
                           (px_int) (objx + pScaleBox->scale_pt[0].x),
                           (px_int) (objx + pScaleBox->scale_pt[0].y),
                           (px_int) (objx + pScaleBox->scale_pt[1].x),
            ...
            PX_GeoDrawLine(psurface,
                           (px_int) (objx + pScaleBox->edit_pt[1].x),
                           (px_int) (objx + pScaleBox->edit_pt[1].y),
                           (px_int) (objx + pScaleBox->edit_pt[2].x),
            ...
            PX_GeoDrawLine(psurface,
                           (px_int) (objx + pScaleBox->scale_pt[1].x),
                           (px_int) (objx + pScaleBox->scale_pt[1].y),
                           (px_int) (objx + pScaleBox->scale_pt[2].x),
            ...
            PX_GeoDrawLine(psurface,
                           (px_int) (objx + pScaleBox->edit_pt[2].x),
                           (px_int) (objx + pScaleBox->edit_pt[2].y),
                           (px_int) (objx + pScaleBox->edit_pt[3].x),
                           (px_int) (objx + pScaleBox->edit_pt[3].y),
                           1,
                           (pScaleBox->linecolor));
            PX_GeoDrawLine(psurface,
                           (px_int) (objx + pScaleBox->scale_pt[2].x),
                           (px_int) (objx + pScaleBox->scale_pt[2].y),
                           (px_int) (objx + pScaleBox->scale_pt[3].x),
                           (px_int) (objx + pScaleBox->scale_pt[3].y),
                           1,
                           (pScaleBox->linecolor));
            ...
            PX_GeoDrawSolidCircle(psurface,
                                  ...
                                  3,
                                  pScaleBox->linecolor);
            if (pScaleBox->current_cursorpt == 0
                || pScaleBox->current_selectpt == 0) {
            ...
            PX_GeoDrawSolidCircle(psurface,
                                  ...
                                  3,
                                  pScaleBox->linecolor);
            if (pScaleBox->current_cursorpt == 1
            ...
            PX_GeoDrawSolidCircle(psurface,
                                  ...
                                  3,
                                  pScaleBox->linecolor);
            if (pScaleBox->current_cursorpt == 2
                || pScaleBox->current_selectpt == 2) {
                PX_GeoDrawCircle(psurface,
                                 (px_int) (objx + mpt.x),
                                 (px_int) (objx + mpt.y),
                                 5,
            ...
            PX_GeoDrawSolidCircle(psurface,
                                  ...
                                  3,
                                  pScaleBox->linecolor);
            if (pScaleBox->current_cursorpt == 3
                || pScaleBox->current_selectpt == 3) {
                PX_GeoDrawCircle(psurface,
                                 (px_int) (objx + mpt.x),
                                 (px_int) (objx + mpt.y),
                                 5,
...
px_void PX_Object_ScaleBoxOnCursorDown(PX_Object *pObject,
                                       PX_Object_Event e,
                                       px_void *ptr) {
    PX_Object_ScaleBox *pscalebox = PX_Object_GetScaleBox(pObject);
    px_float inheritX, inheritY;
    ...
    if (pscalebox->editpt_count == 3) {
        ...
        select_pt[0].x
            = (pscalebox->scale_pt[0].x + pscalebox->scale_pt[1].x) / 2;
        select_pt[0].y
            = (pscalebox->scale_pt[0].y + pscalebox->scale_pt[1].y) / 2;

        select_pt[1].x
            = (pscalebox->scale_pt[2].x + pscalebox->scale_pt[1].x) / 2;
        select_pt[1].y
            = (pscalebox->scale_pt[2].y + pscalebox->scale_pt[1].y) / 2;

        select_pt[2].x
            = (pscalebox->scale_pt[2].x + pscalebox->scale_pt[3].x) / 2;
        select_pt[2].y
            = (pscalebox->scale_pt[2].y + pscalebox->scale_pt[3].y) / 2;

        select_pt[3].x
            = (pscalebox->scale_pt[0].x + pscalebox->scale_pt[3].x) / 2;
        select_pt[3].y
            = (pscalebox->scale_pt[0].y + pscalebox->scale_pt[3].y) / 2;
        ...
        pscalebox->edit_pt[pscalebox->editpt_count]
            = PX_POINT2D(PX_Object_Event_GetCursorX(e) - inheritX,
                         PX_Object_Event_GetCursorY(e) - inheritY);
        pscalebox->editpt_count++;
        if (pscalebox->editpt_count == 3) {
            PX_memcpy(pscalebox->scale_pt,
                      pscalebox->edit_pt,
                      3 * sizeof(px_point2D));
            pscalebox->edit_pt[3] = PX_Point2DAdd(
                pscalebox->edit_pt[0],
                PX_Point2DSub(pscalebox->edit_pt[2], pscalebox->edit_pt[1]));
            pscalebox->scale_pt[3] = pscalebox->edit_pt[3];
        }
    }
}
px_void PX_Object_ScaleBoxOnCursorDrag(PX_Object *pObject,
                                       PX_Object_Event e,
                                       px_void *ptr) {
    PX_Object_ScaleBox *pscalebox = PX_Object_GetScaleBox(pObject);
    px_float inheritX, inheritY;
...
px_void PX_Object_ScaleBoxOnCursorMove(PX_Object *pObject,
                                       PX_Object_Event e,
                                       px_void *ptr) {
    PX_Object_ScaleBox *pscalebox = PX_Object_GetScaleBox(pObject);
    px_float inheritX, inheritY;
...
PX_Object *PX_Object_ScaleBoxCreate(px_memorypool *mp, PX_Object *Parent) {
    ...
    PX_ObjectRegisterEvent(pObject,
                           ...
                           PX_Object_ScaleBoxOnCursorMove,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject,
                           PX_OBJECT_EVENT_CURSORDRAG,
                           PX_Object_ScaleBoxOnCursorDrag,
                           PX_NULL);
    return pObject;
}
