...
typedef PX_Partical_Atom (*PX_ParticalLauncher_CreateAtom)(
    struct _PX_Partical_Launcher *launcher, px_int index);
typedef px_void (*PX_ParticalLauncher_UpdateAtom)(
    struct _PX_Partical_Launcher *launcher, PX_Partical_Atom *pAtom);
